# pos /share2/pub/zhenggw/zhenggw/TwoSampleMR/eyedisease/NC/207GM-4DR/GM-riskresult/
...
library(dplyr)
library(ieugwasr)
setwd("/share2/pub/zhenggw/zhenggw/TwoSampleMR/eyedisease/NC/207GM-4DR/GM-riskresult/")
